module Ibanity
  module Xs2a
    class TransactionDeleteRequest < Ibanity::BaseResource
      def self.create_for_customer(idempotency_key: nil, **attributes)
      ...
      def self.create_for_financial_institution_and_account(idempotency_key: nil, financial_institution_id: nil, account_id: nil, **attributes)
